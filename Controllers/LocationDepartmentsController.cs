...
namespace MedOffice.Controllers
{
    public class LocationDepartmentsController : Controller
    {
        ...
        public ActionResult New(LocationDepartment locationDepartment)
        {
            ...
            //var selectedloc = db.Locations.Find(HttpContext.Request.Params.Get("newLoc"));
            //locationDepartment.Location = selectedloc;
            //locationDepartment.LocationId = selectedloc.LocationId;

            //var selectedDep = db.Departments.Find(HttpContext.Request.Params.Get("newDep"));
            //locationDepartment.Department = selectedDep;
            //locationDepartment.DepartmentId = selectedDep.DepartmentId;
